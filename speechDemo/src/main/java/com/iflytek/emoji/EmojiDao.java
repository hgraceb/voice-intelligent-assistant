...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        //复制的话这里需要换成自己项目的包名
        File dir = new File("data/data/" + "com.iflytek.voicedemo" + "/databases");
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                inputStream = SpeechApp.mSpeechApp.getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
